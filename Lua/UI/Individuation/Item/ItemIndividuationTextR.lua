--author: 	Amu
--time:		2020-07-14 11:47:16

local ItemIndividuationTextR = fgui.extension_class(GComponent)
fgui.register_extension("ui://Individuation/itemIndividuationTextR", ItemIndividuationTextR)

ItemIndividuationTextR.tempList = {}

function ItemIndividuationTextR:ctor()
...
function ItemIndividuationTextR:InitEvent()

end

function ItemIndividuationTextR:SetData(text)
    self._text.text = text
    self:Refresh()
end

function ItemIndividuationTextR:Refresh()
