--[[
    author:{chenkfan}
    time:2019-11-26 10:16:34
    function:{UI2.0 兵力详情}
]]
local ItemArmy = fgui.extension_class(GComponent)
fgui.register_extension("ui://WorldCity/itemArmy", ItemArmy)
...
function ItemArmy:ctor()
    self._controller = self:GetController("c1")
end

function ItemArmy:Init(data)
...
function ItemArmy:BeastInit(data)
