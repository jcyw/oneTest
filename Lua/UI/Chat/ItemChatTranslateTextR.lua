...
local ItemChatTranslateTextR = fgui.extension_class(GComponent)
fgui.register_extension("ui://Chat/itemChatTranslateTextR", ItemChatTranslateTextR)

ItemChatTranslateTextR.tempList = {}

function ItemChatTranslateTextR:ctor()
...
function ItemChatTranslateTextR:InitEvent()
...
function ItemChatTranslateTextR:SetData(text, transText)
...
function ItemChatTranslateTextR:Refresh(transText)
